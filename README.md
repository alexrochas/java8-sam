...
This is a sample template for java8-sam - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name java8-sam --query 'Stacks[].Outputs'
```
